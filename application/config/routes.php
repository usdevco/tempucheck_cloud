...
$route['admin/invoice/save-qb-invoice/(:num)']  = "admin/invoices/save_qb_order_invoice/$1";
...
// $route['save-invoice/(:num)/(:num)/(:any)/(:any)/(:any)/(:any)/(:any)']  = "invoice/save_invoice_data/$1/$2/$3/$4/$5/$6/$7";
$route['save-invoice']  = "invoice/save_invoice_data";
