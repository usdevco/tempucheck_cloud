...
class Qb_oauth_endpoint extends CI_Controller {
    ...
    public function index()
    {
        ...
        $loProvider = @new \League\OAuth2\Client\Provider\GenericProvider([
            ...
            'clientId'              => 'ABhosyTMcTlMU7F2h1UFiwDZlewAEtuJtIIKp4cvRLPAYwHH1o',        
            'clientSecret'          => 'EII1mtFuwtdC1q9MzUElUcsyboMn2g15AfG73ILg',    
            'redirectUri'           => 'http://localhost/tempucheck-crm/Qb_oauth_endpoint',
