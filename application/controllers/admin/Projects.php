...
class Projects extends Admin_controller
{
    ...
    public function project($id = '')
    {
        ...
        if (count($data['last_project_settings'])) {
            ...
            $data['last_project_settings'][$key]['value'] = $data['last_project_settings'][$key]['value'] ? unserialize($data['last_project_settings'][$key]['value']) : $data['last_project_settings'][$key]['value'];
        }
