<?php
$leads_db_fields = $this->db->list_fields('tblapplicants');
            ...
            <div class="table-responsive no-dt">
              <table class="table table-hover table-bordered">
                <thead>
                  <tr>
                                                                  <th class="bold"> Id</th>
                                                                  <th class="bold"> First_name</th>
                                                                  <th class="bold"> Last_name</th>
                                                                  <th class="bold"> Email</th>
                                                                  <th class="bold"> Phone</th>
                                                                  <th class="bold"> Preffered_time</th>
                                                                  <th class="bold"> Position</th>
                                                                  <th class="bold"> Computer</th>
                                                                  <th class="bold"> Screen</th>
                                                                  <th class="bold"> Zoom</th>
                                                                  <th class="bold"> Resume</th>
                                                                  <th class="bold"> DL</th>
                                                                  <th class="bold"> T&amp;C</th>
                                                                  <th class="bold"> Attended_webinar</th>
                                                                  <th class="bold"> Webinar_invite</th>
                                                                  <th class="bold"> Opt</th>
                                                                  <th class="bold"> _e_course</th>
                                                                  <th class="bold"> Onboarded</th>
                                                                  <th class="bold"> Territory_manager_interest</th>
                                                                  <th class="bold"> Needs_another_webinar</th>
                                                                 <!--  <th class="bold"> Tags</th> -->
                                                                </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr>
                      <td><?php echo $row->id; ?></td>
                        ...
                        <td><?php echo $row->last_name; ?></td>
                         <td><?php echo $row->email; ?></td>
                          <td><?php echo $row->phone; ?></td>
                           <td><?php echo $row->preffered_time; ?></td>
                       ...
                       <td><?php echo $row->DL; ?></td>
                        <td><?php echo $row->t_c; ?></td>
                         <td><?php echo $row->attended_webinar; ?></td>
                          <td><?php echo $row->webinar_invite; ?></td>
                           <td><?php echo $row->opt; ?></td>
                       <td><?php echo $row->_e_course; ?></td>
                        <td><?php echo $row->onboarded; ?></td>
                         <td><?php echo $row->territory_manager_interest; ?></td>
                          <td><?php echo $row->needs_another_webinar; ?></td>
                    </tr>
                  <?php } ?>
                  </tbody>
                </table>
