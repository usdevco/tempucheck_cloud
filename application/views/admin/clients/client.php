   ...
   <div class="content">
      <div class="row">
         ...
         <div class="btn-bottom-toolbar btn-toolbar-container-out text-right">
            ...
            <!-- <button class="btn btn-info save-and-add-contact-only customer-form-submiter"> save customer add contatact only
            <?php //echo _l( 'save_customer_and_add_contact_only'); ?>
            </button> -->
            <?php } ?>
         </div>
         <?php } ?>
