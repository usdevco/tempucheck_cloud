...
<div class="modal fade" id="contact" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                       ...
                       <div class="form-group contact-autofill-option">
                            <div class="">
                                <input type="checkbox" id="contact-autofill"  value="1" name="contact-autofill">
                                <label class="onoffswitch1-label" for="<?php echo $contactid; ?>">Auto Fill firstname, phonenumber</label>
                            </div>
                        </div>						
    ...
    <div class="modal-footer">
	    <?php if(isset($save_contact_only)){ ?>
		<input type="hidden" name="save_contact_only" value="<?php echo $save_contact_only; ?>" > 
        <?php } ?> 		
...
<?php if(!isset($contact)){ ?>
    <script>
		...
		$(document).ready(function() {
			...
			//set initial state.
			$('#contact-autofill').change(function() {
				if(this.checked) {
					//var returnVal = confirm("Are you sure?");
					//$(this).prop("checked", returnVal);
					
					$('#firstname').val('<?php echo $client->company ?>');
					$('#phonenumber').val('<?php echo $client->phonenumber ?>');
					$('#email').val('<?php echo get_custom_field_value($customer_id, 9, 'customers', false); ?>');					
				}else{
					$('#firstname').val(''); 
					$('#phonenumber').val('');
					$('#email').val('');								
