...
<head>
    ...
    <?php }else{?>
        <link name="favicon" type="image/x-icon" href="<?php echo base_url('/assets/images/favicon.png'); ?>" rel="shortcut icon" />
        <?php } ?>
    ...
    <?php } ?>
    <link href='<?php echo base_url('assets/css/spacing_bs4.css'); ?>' rel='stylesheet' />
