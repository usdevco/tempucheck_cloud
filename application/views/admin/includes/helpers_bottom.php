...
<!-- Lead Data Add/Edit-->
<div class="modal fade applicant-modal" id="applicant-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
  <div class="modal-dialog <?php echo get_option('applicant-modal_class'); ?>">
    <div class="modal-content data">
