 ...
 <div class="panel_s mbot10">
  <div class="panel-body _buttons">
   ...
   <?php } ?>
    ...
    <?php  if (get_staff_user_id() || is_admin()) { 
      $authUrl = isset($authUrl) ? $authUrl : NULL;
      ?>


<!--     <a href="javascript:void(0)" class="btn btn-sm btn-warning ml-5 record_in_qb_btn" data-id="26"><?php //echo _l('Record in QB'); ?></a> 

    <?php /** if(isset($_SESSION['sessionAccessToken']) && $_SESSION['sessionAccessToken']) { ?>
    <a href="javascript:void(0)" class="btn btn-sm btn-success ml-5 btn_qb_connected"><?php echo _l('QB Connected'); ?></a>
    <?php } else { ?>
    <a href="javascript:void(0)" onclick="oauth.loginPopup()" class="btn btn-sm btn-danger ml-5"><?php echo _l('Connect TO QB'); ?></a>
    <?php } */ ?>
    -->
    
    <input type="hidden" id="qu_authUrl" value="<?php echo $authUrl; ?>">
    <?php }?>
