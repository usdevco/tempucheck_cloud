    ...
    <div class="panel-body">
        <div class="col-md-10 col-md-offset-1">
            <div class="row">
                ...
                <div class="col-md-6 text-right _buttons">
                    ...
                    <?php echo form_open($this->uri->uri_string()); ?>
                      ...
                      <a href="javascript:void(0)<?php //echo admin_url('invoices/invoice'); ?>" class="btn btn-sm btn-warning"><?php echo _l('Record in QB'); ?></a>
                      <?php }?>
            ...
            <?php foreach($invoice->attachments as $attachment){
                ...
                <?php } ?>
                <?php } ?>
                <?php if(!empty($invoice->clientnote) && $invoice->woo_commerce !='WOO-COMMERCE'){ ?>
                <div class="col-md-12"> 
